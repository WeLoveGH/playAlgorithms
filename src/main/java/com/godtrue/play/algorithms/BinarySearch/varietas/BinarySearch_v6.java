...
public class BinarySearch_v6 {
    ...
    public static void main(String[] args) {
        ...
        for(int i = -3; i< BinarySearch_v6.MAX_LOOP; i++){
...
i = 2, indexOfTargetInArr = 0
i = 3, indexOfTargetInArr = 1
i = 4, indexOfTargetInArr = 1
i = 5, indexOfTargetInArr = 1

i = 6, indexOfTargetInArr = 6
i = 7, indexOfTargetInArr = 6
i = 8, indexOfTargetInArr = 6

i = 9, indexOfTargetInArr = 7

i = 10, indexOfTargetInArr = 8
i = 11, indexOfTargetInArr = 8
i = 12, indexOfTargetInArr = 8
i = 13, indexOfTargetInArr = 8
i = 14, indexOfTargetInArr = 8
