 ...
 *
 *              变种6：
 *              查找第一个大于key的元素，也就是说返回大于key的最左边元素下标
 *
 * @author：qianyingjie1
 * @create：2019-12-10
 */
public class BinarySearch_v8 {
    ...
    public static void main(String[] args) {
        ...
        for(int i = -3; i< BinarySearch_v8.MAX_LOOP; i++){
...
target = 1, indexOfTargetInArr = 1
target = 2, indexOfTargetInArr = 2

target = 3, indexOfTargetInArr = 2
target = 4, indexOfTargetInArr = 2

target = 5, indexOfTargetInArr = 7
target = 6, indexOfTargetInArr = 7
target = 7, indexOfTargetInArr = 7

target = 8, indexOfTargetInArr = 8
target = 9, indexOfTargetInArr = -1
